...
def main():
    ...
    parser_dns_create = subparsers.add_parser("create-dns-record", help="Create a new DNS record.")
    ...
    parser_dns_edit = subparsers.add_parser("update-dns-record", help="Edit an existing DNS record.")
    ...
    parser_dns_delete = subparsers.add_parser("delete-dns-records", help="Delete an existing DNS record.")
    ...
    parser_dns_receive = subparsers.add_parser("get-dns-records", help="Get all DNS records.")
    ...
    parser_dns_export = subparsers.add_parser("export-dns-records", help="Save all DNS records to a local json file.")
    ...
    parser_dns_export.add_argument("filepath", help="The filepath where to save the exported DNS records.")

    parser_dns_export_bind = subparsers.add_parser("export-bind-dns-records",
                                                   help="Save all DNS records to a local BIND file.")
    parser_dns_export_bind.set_defaults(func=PKBClient.export_bind_dns_records)
    parser_dns_export_bind.add_argument("domain",
                                        help="The domain for which the DNS record should be retrieved and saved.")
    parser_dns_export_bind.add_argument("filepath", help="The filepath where to save the exported DNS records.")

    parser_dns_import = subparsers.add_parser("import-dns-records",
    ...
    parser_dns_import.add_argument("filepath", help="The filepath from which the DNS records are to be restored.")
    parser_dns_import.add_argument("restore_mode", help="""The restore mode (DNS records are identified by the record type, name and prio if supported):
    ...
    parser_dns_import_bind = subparsers.add_parser("import-bind-dns-records",
    ...
    parser_dns_import_bind.add_argument("filepath", help="The filepath from which the DNS records are to be restored.")
    ...
    parser_domain_pricing = subparsers.add_parser("get-domain-pricing", help="Get the pricing for Porkbun domains.")
    parser_domain_pricing.set_defaults(func=PKBClient.get_domain_pricing)

    parser_ssl_retrieve = subparsers.add_parser("get-ssl-bundle", help="Retrieve an SSL bundle for given domain.")
    ...
    parser_update_dns_server = subparsers.add_parser("update-dns-servers", help="Update the DNS servers for a domain.")
    ...
    parser_get_dns_server = subparsers.add_parser("get-dns-servers", help="Retrieve the DNS servers for a domain.")
    ...
    parser_list_domains = subparsers.add_parser("get-domains",
    ...
    parser_get_url_forward = subparsers.add_parser("get-url-forwards", help="Retrieve all URL forwards.")
    ...
    parser_add_url_forward = subparsers.add_parser("create-url-forward", help="Create a new URL forward.")
    ...
    parser_delete_url_forward = subparsers.add_parser("delete-url-forward", help="Delete an existing URL forward.")
